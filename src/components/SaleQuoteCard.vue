...
<!---------Composant entête fiche----------------------->      
            <div id="card-header-comp">
                <s-q-card-Header soNo="000001" soDesc="propect Gérald" pageTitle="Devis vente"></s-q-card-Header>
            </div>
...
<!---------sous-Section onglet 1 formulaire fiche client----------------------->                         
                    <div id="general">
                        ...
                        <div id="general_content" class="columns">
                            <div class="column">
                                <input-text labelInputText="N° client" :valueInputText="saleQuoteCardHeader['Sell-to Customer No_']" :is_disabled="readOnlyMode" ></input-text>
                                <input-text labelInputText="Nom du client" :valueInputText="saleQuoteCardHeader['Sell-to Customer Name']" :is_disabled="readOnlyMode" ></input-text>
                                <p class="has-text-left">
                                    <span class="title is-6">
                                        Donneur d'ordre
                                    </span>
                                </p>
                                <input-text labelInputText="N° Contact" :valueInputText="saleQuoteCardHeader['Sell-to Contact No_']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Contact" :valueInputText="saleQuoteCardHeader['Ship-to Contact']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Adresse" :valueInputText="saleQuoteCardHeader['Ship-to Address']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Ville" :valueInputText="saleQuoteCardHeader['Ship-to City']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="N° Téléphone" :valueInputText="saleQuoteCardHeader['Sell-to Phone No_']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Adresse e*mail" :valueInputText="saleQuoteCardHeader['Sell-to E-Mail']" :is_disabled="readOnlyMode"></input-text>
                            </div>
                            <div class="column">
                                <input-text labelInputText="Date commande" :valueInputText="saleQuoteCardHeader['']" :is_disabled="readOnlyMode" ></input-text>
                                <input-text labelInputText="Date document" :valueInputText="formatDate(saleQuoteCardHeader['Document Date'])" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Date d'échéance" :valueInputText="saleQuoteCardHeader['']" :is_disabled="readOnlyMode" ></input-text>
                                <input-text labelInputText="Fin de validité devis" :valueInputText="formatDate(saleQuoteCardHeader['Quote Valid Until Date'])" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Date livraison demandée" :valueInputText="formatDate(saleQuoteCardHeader['Requested Delivery Date'])" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Code vendeur" :valueInputText="saleQuoteCardHeader['Salesperson Code']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="N° campagne" :valueInputText="saleQuoteCardHeader['Campaign No_']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Centre de gestion" :valueInputText="saleQuoteCardHeader['Responsibility Center']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Statut" inputTextColor="has-text-primary" inputTextWeight="has-text-weight-bold" :valueInputText="saleQuoteCardHeader['Status']==0?'Ouvert':'Lancé'" :is_disabled="true"></input-text>
                            </div>
                        </div>                    
                    </div>
                    <br><br>
...
<!---------sous-Section onglet 2 formulaire fiche client----------------------->                         
                    <div id="line">
                        ...
                        <div class="columns mt-3" id="line_total" v-if="onglet2_expanded">
                                ...
                                <div class="column">
                                    <input-text1 :is_disabled="true" :valueInputText="saleQuoteCardHeader['Total Amount']" labelInputText="Total HT"></input-text1>
                                    <input-text1 :is_disabled="true" :valueInputText="saleQuoteCardHeader['Total Amount Including VAT']" labelInputText="Total TTC"></input-text1>
                                </div>
                        </div>                
                    </div>                         
                    <br><br>
...
<!---------sous-Section ongle 3 formulaire fiche client----------------------->                         
                    <div id="details-facture">
                        ...
                        <div id="invoice_details_content" class="columns">
                            <div class="column">
                                <input-text labelInputText="Groupe compta. marché TVA" :valueInputText="saleQuoteCardHeader['Gen_ Bus_ Posting Group']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Code condition paiement" :valueInputText="saleQuoteCardHeader['Payment Terms Code']" :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Code condition règlement" :valueInputText="saleQuoteCardHeader['Payment Method Code']" :is_disabled="readOnlyMode"></input-text>
                            </div>
                            <div class="column">
                                <input-text labelInputText="Code magasin" :valueInputText="saleQuoteCardHeader['Location Code']" :is_disabled="readOnlyMode"></input-text>
                            </div>
                        </div>                    
                    </div>
                    <br><br>
...
<!---------sous-Section ongle 4 formulaire fiche client----------------------->                         
                    <div id="expedition-facturation">
                        ...
                        <div id="delivery_invoicing_content" class="columns">
                            <div class="column">
                                <input-text labelInputText="Code mode livraison" :valueInputText="saleQuoteCardHeader['Shipment Method Code']" :is_disabled="readOnlyMode"></input-text>
                                <p class="has-text-left">
                                    <span class="title is-6">
                                        Conditions de livraison
                                    </span>
                                </p>
                                <input-text labelInputText="Code" :valueInputText="saleQuoteCardHeader['Ship-to Code']"  :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Contact" :valueInputText="saleQuoteCardHeader['Ship-to Contact']" :is_disabled="readOnlyMode"></input-text>
                            </div>
                            <div class="column">
                                <input-text labelInputText="Nom" :valueInputText="saleQuoteCardHeader['Ship-to Name']"  :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Adresse" :valueInputText="saleQuoteCardHeader['Ship-to Address']"  :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Adresse (2ème ligne)" :valueInputText="saleQuoteCardHeader['']"  :is_disabled="readOnlyMode"></input-text>
                                <input-text labelInputText="Ville" :valueInputText="saleQuoteCardHeader['Ship-to City']" :is_disabled="readOnlyMode"></input-text>
                            </div>
                        </div>                    
                    </div>
...
export default {
    ...
    setup(){
        ...
        return {
            saleQuoteCardHeader,saleQuoteCardLines,readOnlyMode
        }
    },
    data(){
        return{
    ...
    mounted(){
        axios.get(`http://localhost:3000/app/getSQCard/${this.saleQuoteCardId}`)
        .then(result => {
            this.saleQuoteCardHeader = result.data[0],
